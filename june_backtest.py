"""
June 1–24 2026 Backtest — All 5 agents, LONG+SHORT, x50 leverage
...
# June 1 2026 00:00:00 UTC  →  June 24 2026 23:59:59 UTC
...
print(f"\n{'='*68}", flush=True)
print(f"  JUNE 1–24 2026 Backtest — x50 Leverage", flush=True)
...
print(f"\n{'='*68}", flush=True)
print(f"  JUNE 1–24 SUMMARY", flush=True)
