"""
Competition 9 — 9 agents with ATR dynamic SL/TP + trailing stops + Supertrend (port 8130).
"""
import sys, os
...
PORT      = 8130
MAX_OPEN  = 3
COMP_NAME = "Competition 9 — ATR Dynamic + Supertrend"
PASSWORD  = "BOT2024"
SAVE_FILE = os.path.join(os.path.dirname(__file__), "comp9_state.json")
